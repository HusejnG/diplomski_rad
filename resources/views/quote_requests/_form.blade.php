...
{{-- Latitude i Longitude za sada ostaju opcioni i ne prikazuju se u formi, ali su u bazi --}}
{{-- <div class="mb-3">
...
<div class="mb-3">
    <label for="avg_monthly_consumption_kwh" class="form-label">Prosečna Mesečna Potrošnja Energije (kWh)</label>
